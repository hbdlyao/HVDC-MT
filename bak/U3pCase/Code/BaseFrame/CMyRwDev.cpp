///////////////////////////////////////////////////////////
//  CMyRwDev.cpp
//  Implementation of the Class CMyRwDev
...
void CMyRwDev::InitGrid(CDevGrid * vGrid) 
{
	pGrid = vGrid;
}


string CMyRwDev::StaField(int vStaCount, int vIndex)
{
	string vStr;
...
string CMyRwDev::NodeNameField(int vStaCount, int vIndex)
{
...
string CMyRwDev::NodeIDField(int vStaCount, int vIndex)
{
...
string CMyRwDev::GetSQL_Load()
{
	return "select * from " + tblName;
}

void CMyRwDev::OnLoad()
{
	CDevTBL * vTBL;
	CDevBase * vDev;
...
void CMyRwDev::doLoad(CDevBase * vDevice)
{
	int i;
	string vFieldName;
	string vStr;
...
void CMyRwDev::doSave(CDevBase * vDevice)
{
	int i;
	string vFieldName;

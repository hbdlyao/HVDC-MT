...
//  Created on:      25-5月-2017 15:03:36
...
void CxbU3pData::doInitData(int vDim)
{
	...
	//pData->Ure = new double[vDim];
	//pData->Uim = new double[vDim];
 ...
 * 3P的电压实部
 */
double CxbU3pData::hUre(int vhOrder){
 ...
 * 3P的电压虚部
 */
double CxbU3pData::hUim(int vhOrder){
 ...
 * 3P的电流实部
 */
double CxbU3pData::hIre(int vhOrder){

	//
		return pData->Ire[vhOrder-1];
}
 ...
 * 3P的电流虚部
 */
double CxbU3pData::hIim(int vhOrder){

	return pData->Iim[vhOrder-1];
}


double CxbU3pData::hYg(int vhOrder){

	return 0;
}


double CxbU3pData::hYb(int vhOrder){
